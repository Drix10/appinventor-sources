...
Blockly.Versioning.upgrade = function (
  ...
  Blockly.Versioning.log(
    "Blockly.Versioning.upgrade: Final conversion to Blockly.common.getMainWorkspace()"
  );
...
Blockly.Versioning.ensureDom = function (blocksRep) {
  if (Blockly.Versioning.isDom(blocksRep)) {
    ...
    Blockly.Versioning.log(
      "Blockly.Versioning.ensureDom: converting Blockly.common.getMainWorkspace() to dom"
    );
...
Blockly.Versioning.ensureWorkspace = function (blocksRep, opt_workspace) {
  if (Blockly.Versioning.isWorkspace(blocksRep)) {
    ...
    Blockly.Versioning.log(
      "Blockly.Versioning.ensureWorkspace: converting dom to Blockly.common.getMainWorkspace()"
    );
...
Blockly.Versioning.createUpgraders = function (preUpgradeFormJsonString) {
  ...
  for (var componentType in preUpgradeComponentVersionDict) {
    ...
    if (preUpgradeVersion > currentVersion) {
      ...
      console.log("Unexpected: preUpgradeVersion of " + componentType + " = " + preUpgradeVersion
